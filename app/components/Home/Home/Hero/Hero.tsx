...
return (
    <div className='relative w-full h-[100vh] sm:h-[100vh]'>
        {/* Overlay */}
        <div className='absolute top-0 left-0 w-full h-full bg-blue-500 opacity-80'>
        <video 
        src="/images/NepArial.mp4"
        autoPlay
        loop
        muted
        preload='metadata'
        ...
        <div className='absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
            <div className='flex items-center justify-center flex-col w-full h-full'>
                <div>
                    <h1 className='text-[25px] mb-4 md:mb-0 text-center md:text-[35px] lg:text-[45px] tracking-[0.7rem] text-white font-extrabold uppercase drop-shadow-[3px_3px_5px_rgba(0,0,0,0.7)]'>Travel Smart, Spend Less</h1>
